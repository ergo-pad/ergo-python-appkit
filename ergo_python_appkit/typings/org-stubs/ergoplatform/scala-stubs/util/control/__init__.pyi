...
class Exception:
    ...
    class Catch(scala.util.control.Exception.Described, typing.Generic[_Exception__Catch__T]):
        ...
        def scala$util$control$Exception$Described$$_desc(self) -> java.lang.String: ...
        def scala$util$control$Exception$Described$$_desc_$eq(self, x$1: typing.Union[java.lang.String, str]) -> None: ...
        ...
        def withDesc(self, s: typing.Union[java.lang.String, str]) -> 'Exception.Described': ...
