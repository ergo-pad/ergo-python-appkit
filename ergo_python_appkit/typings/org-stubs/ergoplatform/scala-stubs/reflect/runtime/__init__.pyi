...
class SynchronizedTypes(scala.reflect.internal.Types):
    ...
    def indent(self) -> java.lang.String: ...
    def indent_$eq(self, value: typing.Union[java.lang.String, str]) -> None: ...
    ...
    def scala$reflect$runtime$SynchronizedTypes$$_indent(self) -> 'ThreadLocalStorage.ThreadLocalStorage'[java.lang.String]: ...
...
class JavaMirrors(scala.reflect.api.JavaUniverse, TwoWayCaches):
    ...
    class JavaMirror(scala.reflect.internal.Mirrors.Roots, scala.reflect.api.JavaUniverse.JavaMirror):
        ...
        def javaClass(self, path: typing.Union[java.lang.String, str]) -> typing.Type[typing.Any]: ...
        ...
        def packageNameToScala(self, fullname: typing.Union[java.lang.String, str]) -> scala.reflect.internal.Symbols.ModuleSymbol: ...
        ...
        def scala$reflect$runtime$JavaMirrors$$makeScalaPackage(self, fullname: typing.Union[java.lang.String, str]) -> scala.reflect.internal.Symbols.ModuleSymbol: ...
        ...
        def scala$reflect$runtime$JavaMirrors$JavaMirror$$abort(self, msg: typing.Union[java.lang.String, str]) -> scala.runtime.Nothing.: ...
        ...
        def staticPackage(self, fullname: typing.Union[java.lang.String, str]) -> scala.reflect.internal.Symbols.ModuleSymbol: ...
        ...
        def tryJavaClass(self, path: typing.Union[java.lang.String, str]) -> scala.Option[typing.Type[typing.Any]]: ...
        ...
        class toAnnotArg$:
            ...
            def StringClass(self) -> typing.Type[java.lang.String]: ...
...
class JavaUniverse(scala.reflect.internal.SymbolTable, JavaUniverseForce, ReflectSetup, scala.reflect.runtime.SymbolTable):
    ...
    def currentRunId(self) -> int: ...
    def debugInfo(self, msg: scala.Function0[typing.Union[java.lang.String, str]]) -> None: ...
    def defineBaseClassesOfCompoundType(self, tpe: scala.reflect.internal.Types.CompoundType) -> None: ...
    def defineBaseTypeSeqOfCompoundType(self, tpe: scala.reflect.internal.Types.CompoundType) -> None: ...
    def defineBaseTypeSeqOfTypeRef(self, tpe: scala.reflect.internal.Types.TypeRef) -> None: ...
    def defineParentsOfTypeRef(self, tpe: scala.reflect.internal.Types.TypeRef) -> None: ...
    ...
    def indent(self) -> java.lang.String: ...
    def indent_$eq(self, value: typing.Union[java.lang.String, str]) -> None: ...
    def info(self, msg: scala.Function0[typing.Union[java.lang.String, str]]) -> None: ...
    def init(self) -> None: ...
    ...
    def newFreeTermSymbol(self, name: scala.reflect.internal.Names.TermName, value: scala.Function0[typing.Any], flags: int, origin: typing.Union[java.lang.String, str]) -> scala.reflect.internal.Symbols.FreeTermSymbol: ...
    def newFreeTermSymbol$default$3(self) -> int: ...
    def newFreeTermSymbol$default$4(self) -> java.lang.String: ...
    def newFreeTypeSymbol(self, name: scala.reflect.internal.Names.TypeName, flags: int, origin: typing.Union[java.lang.String, str]) -> scala.reflect.internal.Symbols.FreeTypeSymbol: ...
    def newFreeTypeSymbol$default$2(self) -> int: ...
    def newFreeTypeSymbol$default$3(self) -> java.lang.String: ...
    ...
    class PerRunReporting(scala.reflect.internal.Reporting.PerRunReportingBase):
        ...
        def deprecationWarning(self, pos: scala.reflect.internal.util.Position, msg: typing.Union[java.lang.String, str], since: typing.Union[java.lang.String, str]) -> None: ...
...
class ReflectionUtils:
    ...
    @staticmethod
    def innerSingletonInstance(outer: typing.Any, className: typing.Union[java.lang.String, str]) -> typing.Any: ...
    @staticmethod
    def show(cl: java.lang.ClassLoader) -> java.lang.String: ...
    @typing.overload
    @staticmethod
    def staticSingletonInstance(clazz: typing.Type[typing.Any]) -> typing.Any: ...
    @typing.overload
    @staticmethod
    def staticSingletonInstance(cl: java.lang.ClassLoader, className: typing.Union[java.lang.String, str]) -> typing.Any: ...
...
class Settings(scala.reflect.internal.settings.MutableSettings):
    ...
    class MultiStringSetting(scala.reflect.runtime.Settings.Setting):
        $outer: 'Settings' = ...
        def __init__(self, $outer: 'Settings', xs: scala.collection.immutable.List[typing.Union[java.lang.String, str]]): ...
        def isDefault(self) -> bool: ...
        def isSetByUser(self) -> bool: ...
        def postSetHook(self) -> None: ...
        def setByUser(self) -> bool: ...
        def setByUser_$eq(self, x$1: bool) -> None: ...
        def v(self) -> scala.collection.immutable.List[java.lang.String]: ...
        def v_$eq(self, x$1: scala.collection.immutable.List[typing.Union[java.lang.String, str]]) -> None: ...
        def value(self) -> scala.collection.immutable.List[java.lang.String]: ...
        def valueSetByUser(self) -> scala.Option[typing.Any]: ...
        def value_$eq(self, arg: typing.Any) -> None: ...
