...
class NameTransformer:
    @staticmethod
    def LAZY_LOCAL_SUFFIX_STRING() -> java.lang.String: ...
    @staticmethod
    def LOCAL_SUFFIX_STRING() -> java.lang.String: ...
    @staticmethod
    def MODULE_INSTANCE_NAME() -> java.lang.String: ...
    @staticmethod
    def MODULE_SUFFIX_STRING() -> java.lang.String: ...
    @staticmethod
    def MODULE_VAR_SUFFIX_STRING() -> java.lang.String: ...
    @staticmethod
    def NAME_JOIN_STRING() -> java.lang.String: ...
    @staticmethod
    def SETTER_SUFFIX_STRING() -> java.lang.String: ...
    @staticmethod
    def TRAIT_SETTER_SEPARATOR_STRING() -> java.lang.String: ...
    @staticmethod
    def decode(name0: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @staticmethod
    def encode(name: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    class OpCodes:
        def __init__(self, op: str, code: typing.Union[java.lang.String, str], next: 'NameTransformer.OpCodes'): ...
...
class ScalaLongSignature(java.lang.annotation.Annotation):
    def bytes(self) -> typing.List[java.lang.String]: ...
...
class ClassManifestDeprecatedApis(OptManifest[_ClassManifestDeprecatedApis__T], typing.Generic[_ClassManifestDeprecatedApis__T]):
    ...
    def argString(self) -> java.lang.String: ...
...
class AnyValManifest(scala.reflect.Manifest[_AnyValManifest__T], typing.Generic[_AnyValManifest__T]):
    ...
    def __init__(self, toString: typing.Union[java.lang.String, str]): ...
    def $greater$colon$greater(self, that: 'ClassTag'[typing.Any]) -> bool: ...
    def $less$colon$less(self, that: 'ClassTag'[typing.Any]) -> bool: ...
    def argString(self) -> java.lang.String: ...
    _arrayClass__T = typing.TypeVar('_arrayClass__T')  # <T>
...
class ClassManifestFactory:
    ...
    @typing.overload
    @staticmethod
    def abstractType(prefix: OptManifest[typing.Any], name: typing.Union[java.lang.String, str], clazz: typing.Type[typing.Any], args: scala.collection.Seq[OptManifest[typing.Any]]) -> 'ClassTag'[_abstractType_0__T]: ...
    @typing.overload
    @staticmethod
    def abstractType(prefix: OptManifest[typing.Any], name: typing.Union[java.lang.String, str], upperbound: 'ClassTag'[typing.Any], args: scala.collection.Seq[OptManifest[typing.Any]]) -> 'ClassTag'[_abstractType_1__T]: ...
    ...
    class AbstractTypeClassManifest(scala.reflect.ClassTag[_ClassManifestFactory__AbstractTypeClassManifest__T], typing.Generic[_ClassManifestFactory__AbstractTypeClassManifest__T]):
        serialVersionUID: typing.ClassVar[int] = ...
        def __init__(self, prefix: OptManifest[typing.Any], name: typing.Union[java.lang.String, str], clazz: typing.Type[typing.Any], args: scala.collection.Seq[OptManifest[typing.Any]]): ...
        def $greater$colon$greater(self, that: 'ClassTag'[typing.Any]) -> bool: ...
        def $less$colon$less(self, that: 'ClassTag'[typing.Any]) -> bool: ...
        def argString(self) -> java.lang.String: ...
        _arrayClass__T = typing.TypeVar('_arrayClass__T')  # <T>
...
class ManifestFactory:
    ...
    @staticmethod
    def abstractType(prefix: Manifest[typing.Any], name: typing.Union[java.lang.String, str], upperBound: typing.Type[typing.Any], args: scala.collection.Seq[Manifest[typing.Any]]) -> Manifest[_abstractType__T]: ...
    _arrayType__T = typing.TypeVar('_arrayType__T')  # <T>
    @staticmethod
    ...
    class AbstractTypeManifest(Manifest[_ManifestFactory__AbstractTypeManifest__T], typing.Generic[_ManifestFactory__AbstractTypeManifest__T]):
        serialVersionUID: typing.ClassVar[int] = ...
        def __init__(self, prefix: Manifest[typing.Any], name: typing.Union[java.lang.String, str], upperBound: typing.Type[typing.Any], args: scala.collection.Seq[Manifest[typing.Any]]): ...
        def $greater$colon$greater(self, that: ClassTag[typing.Any]) -> bool: ...
        def $less$colon$less(self, that: ClassTag[typing.Any]) -> bool: ...
        def argString(self) -> java.lang.String: ...
        _arrayClass__T = typing.TypeVar('_arrayClass__T')  # <T>
    ...
    class PhantomManifest(scala.reflect.ManifestFactory.ClassTypeManifest[_ManifestFactory__PhantomManifest__T], typing.Generic[_ManifestFactory__PhantomManifest__T]):
        serialVersionUID: typing.ClassVar[int] = ...
        def __init__(self, _runtimeClass: typing.Type[typing.Any], toString: typing.Union[java.lang.String, str]): ...
        def equals(self, that: typing.Any) -> bool: ...
        def hashCode(self) -> int: ...
        def toString(self) -> java.lang.String: ...
